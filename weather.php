...
<div class="container">	
	...
	<div class="row">	
		...
		<div class="col-md-6 col-md-offset-3 center">	
			...
			<h1 class="center white">Weather in PHP</h1>	
			...
			<form>	
				...
				<button id="findMyWeather" class="btn btn-warning btn-lg">Get weather</button>	
...
<div style="background-color:black; color:white; padding:20px">Created by Ricardo Maduro while learning Udemy Complete Web Developer Course</div>
